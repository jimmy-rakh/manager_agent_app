...
class ActiveOrdersView extends ViewModelWidget<OrdersScreenModel> {
  ...
  Widget build(BuildContext context, OrdersScreenModel viewModel) {
    return ListView.separated(
      ...
      itemCount: viewModel.activeOrders?.results?.length ?? 0,
      itemBuilder: (BuildContext _, index) {
        final order = viewModel.activeOrders!.results![index];
